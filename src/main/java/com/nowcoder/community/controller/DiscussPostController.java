...
public class DiscussPostController implements CommunityConstant {
    ...
    public String addDiscussPost(String title, String content) {
        ...
        if (user == null) {
            return CommunityUtil.getJSONString(403, "没有权限，请登录！");
        }
    ...
    public String getDiscussPost(@PathVariable("discussPostId") int discussPostId, Model model, Page page) {
        ...
        // 评论：给帖子的评论
        // 回复：给评论的评论
        // 评论结构图：https://www.processon.com/view/link/5df0eb16e4b093b9f77af4eb
        //评论列表（帖子的主评论）
        ...
        if (commentList != null) {
            for (Comment comment : commentList) {
                ...
                // 每个评论的回复数量
                int replyCount = commentService.findCommunityCount(ENTITY_TYPE_COMMENT, comment.getId());
